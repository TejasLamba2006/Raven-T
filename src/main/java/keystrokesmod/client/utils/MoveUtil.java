...
import keystrokesmod.client.mixin.mixins.EntityAccessor;
import keystrokesmod.client.utils.world.PlayerMove;
...
public class MoveUtil {
    ...
    public static double direction() {
        //float rotationYaw = TargetStrafe.getMovementYaw(); for future
