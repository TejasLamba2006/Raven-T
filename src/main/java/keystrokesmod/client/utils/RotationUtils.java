...
public class RotationUtils {
    ...
    public static boolean isMouseOver(final float yaw, final float pitch, final Entity target, final float range) {
        final float partialTicks = Utils.Player.getTimer().renderPartialTicks;
        ...
        for (BlockPos pos : possible) {
            if (BlockUtils.getBlockState(pos).getBlock().isFullBlock()) {
                ...
                if (pos.getY() < blockPos.getY()) {
                    ...
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX() + 0.5, pos.getY() + 1, pos.getZ() + 0.5);
                } else if (pos.getX() > blockPos.getX()) {
                    facing = EnumFacing.WEST;
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX(), pos.getY() + 0.5, pos.getZ() + 0.5);
                } else if (pos.getX() < blockPos.getX()) {
                    facing = EnumFacing.EAST;
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX() + 1, pos.getY() + 0.5, pos.getZ() + 0.5);
                } else if (pos.getZ() < blockPos.getZ()) {
                    facing = EnumFacing.SOUTH;
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 1);
                } else if (pos.getZ() > blockPos.getZ()) {
                    facing = EnumFacing.NORTH;
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ());
                } else {
                    facing = EnumFacing.DOWN;
                    hitPos = new keystrokesmod.client.utils.phys.Vec3(pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5);
                }
